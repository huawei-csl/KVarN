...
static constexpr MicroAPI::CastTrait cast_log_to_half_d256_vf_cfg = { MicroAPI::RegLayout::ZERO, MicroAPI::SatMode::NO_SAT, MicroAPI::MaskMergeMode::ZEROING, RoundMode::CAST_RINT };

__aicore__ inline void cast_log_to_half_d256_vf(__ubuf__ float* src_log, __ubuf__ half* dst){
    __VEC_SCOPE__
    {
        ...
        MicroAPI::Cast<half, float, cast_log_to_half_d256_vf_cfg>(half_values[0], values[0], _tmp_maskreg_1);
        MicroAPI::StoreAlign<half, MicroAPI::StoreDist::DIST_PACK_B32>(dst, half_values[0], _tmp_maskreg_1);
        MicroAPI::Cast<half, float, cast_log_to_half_d256_vf_cfg>(half_values[1], values[1], _tmp_maskreg_1);
