...
static constexpr MicroAPI::CastTrait quantize_pack_4bit_vf_cast_cfg = { MicroAPI::RegLayout::ZERO, MicroAPI::SatMode::NO_SAT, MicroAPI::MaskMergeMode::ZEROING, RoundMode::CAST_RINT };
static constexpr MicroAPI::CastTrait quantize_pack_4bit_vf_half_cfg = { MicroAPI::RegLayout::ZERO, MicroAPI::SatMode::NO_SAT, MicroAPI::MaskMergeMode::ZEROING, RoundMode::CAST_RINT };
static constexpr MicroAPI::CastTrait quantize_pack_4bit_vf_default_castcfg = { MicroAPI::RegLayout::ZERO, MicroAPI::SatMode::NO_SAT, MicroAPI::MaskMergeMode::ZEROING, RoundMode::CAST_RINT };

__aicore__ inline void quantize_pack_4bit_vf(__ubuf__ half* src, __ubuf__ float* best_log_col, __ubuf__ float* best_log_row, __ubuf__ uint8_t* q_scratch, __ubuf__ half* scale_half_out, __ubuf__ half* zp_half_out){
    __VEC_SCOPE__
    {
        ...
        MicroAPI::Cast<float, half, quantize_pack_4bit_vf_default_castcfg>(values[0], _tmp_reg_1, _tmp_maskreg_0);
        MicroAPI::LoadAlign<half, MicroAPI::LoadDist::DIST_UNPACK_B16>(_tmp_reg_1, src + 64);
        MicroAPI::Cast<float, half, quantize_pack_4bit_vf_default_castcfg>(values[1], _tmp_reg_1, _tmp_maskreg_0);
        ...
        MicroAPI::Cast<int, float, quantize_pack_4bit_vf_cast_cfg>(q_int[0], q_values[0], float_mask);
        ...
        MicroAPI::Cast<int, float, quantize_pack_4bit_vf_cast_cfg>(q_int[1], q_values[1], float_mask);
        ...
        MicroAPI::Cast<half, float, quantize_pack_4bit_vf_half_cfg>(half_scale, abs_scale, _tmp_maskreg_5);
        MicroAPI::Cast<half, float, quantize_pack_4bit_vf_half_cfg>(half_zp, abs_zp, _tmp_maskreg_5);
