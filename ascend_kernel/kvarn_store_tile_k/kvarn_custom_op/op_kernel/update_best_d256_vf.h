...
__aicore__ inline void update_best_d256_vf(__ubuf__ float* col_std, __ubuf__ float* row_std, __ubuf__ float* log_scale_col, __ubuf__ float* log_scale_row, __ubuf__ float* best_log_col, __ubuf__ float* best_log_row, __ubuf__ float* best_imbalance){
    __VEC_SCOPE__
    {
        ...
        MicroAPI::RegTensor<float> row_regs[4];
        ...
        MicroAPI::RegTensor<float> log_scale_row_regs[4];
        MicroAPI::RegTensor<float> best_log_col_regs[2];
        MicroAPI::RegTensor<float> best_log_row_regs[4];
        ...
        MicroAPI::LoadAlign<float, MicroAPI::LoadDist::DIST_NORM>(row_regs[2], row_std + 128);
        MicroAPI::LoadAlign<float, MicroAPI::LoadDist::DIST_NORM>(row_regs[3], row_std + 192);
        ...
        MicroAPI::Max(_tmp_reg_2, row_regs[2], row_regs[3], _tmp_maskreg_1);
        MicroAPI::Max(_tmp_reg_0, _tmp_reg_0, _tmp_reg_2, _tmp_maskreg_1);
        MicroAPI::ReduceMax(row_max, _tmp_reg_0, _tmp_maskreg_1);
        MicroAPI::Min(_tmp_reg_0, row_regs[0], row_regs[1], _tmp_maskreg_1);
        MicroAPI::Min(_tmp_reg_2, row_regs[2], row_regs[3], _tmp_maskreg_1);
        MicroAPI::Min(_tmp_reg_0, _tmp_reg_0, _tmp_reg_2, _tmp_maskreg_1);
        ...
        MicroAPI::LoadAlign<float, MicroAPI::LoadDist::DIST_NORM>(log_scale_row_regs[2], log_scale_row + 128);
        MicroAPI::LoadAlign<float, MicroAPI::LoadDist::DIST_NORM>(log_scale_row_regs[3], log_scale_row + 192);
        ...
        MicroAPI::LoadAlign<float, MicroAPI::LoadDist::DIST_NORM>(best_log_row_regs[2], best_log_row + 128);
        MicroAPI::LoadAlign<float, MicroAPI::LoadDist::DIST_NORM>(best_log_row_regs[3], best_log_row + 192);
        ...
        MicroAPI::Select(best_log_row_regs[2], log_scale_row_regs[2], best_log_row_regs[2], better);
        MicroAPI::Select(best_log_row_regs[3], log_scale_row_regs[3], best_log_row_regs[3], better);
        ...
        MicroAPI::StoreAlign<float, MicroAPI::StoreDist::DIST_NORM_B32>(best_log_row + 128, best_log_row_regs[2], _tmp_maskreg_1);
        MicroAPI::StoreAlign<float, MicroAPI::StoreDist::DIST_NORM_B32>(best_log_row + 192, best_log_row_regs[3], _tmp_maskreg_1);
