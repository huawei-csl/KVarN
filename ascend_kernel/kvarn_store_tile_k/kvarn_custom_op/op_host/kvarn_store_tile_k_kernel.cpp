#include "kvarn_store_tile_k_kernel_tiling.h"
...
static ge::graphStatus TilingFunc(gert::TilingContext* context)
{
    ...
    KvarnStoreTileKKernelTilingData tiling;
...
namespace ops {
class KvarnStoreTileKKernel : public OpDef {
public:
    explicit KvarnStoreTileKKernel(const char* name) : OpDef(name)
    {
